...
namespace flashcard_backend.Migrations
{
    ...
    [Migration("20250422052152_adding admin user")]
            ...
            modelBuilder.Entity("flashcard_backend.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 4, 22, 5, 21, 51, 780, DateTimeKind.Utc).AddTicks(8581),
                            Email = "admin@test123.com",
                            FullName = "Admin",
                            PasswordHash = "$2a$13$Yeaw/4AugEcdNFDPRgslmukitVawMJbBq0EvR6W3hfHjlNuF/Cgme",
                            Role = 1,
                            Username = "admin"
                        });
                });
